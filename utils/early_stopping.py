...
class EarlyStopping:
    ...
    def __init__(self, model, path=None, big_server=False, mode='min', compare=None, patience=7, verbose=False, delta=0):
        """
        Args:
    ...
    def __call__(self, score):
        if self.best_score == 0.0 or self.compare(score, self.best_score + self.delta):
            if self.verbose:
